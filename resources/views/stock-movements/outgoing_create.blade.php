...
<body>
    <div class="navbar">
        <h2>👗 Dainty Dream - Record Outgoing</h2>
    </div>

    <div class="container">
        <div class="form-card">
            <h1><img src="{{ asset('StockOutAdd.png') }}" alt="outgoing icon" style="height: 30px; width: 30px; margin-right: 10px; vertical-align: middle;"> Record Outgoing Transaction</h1>
