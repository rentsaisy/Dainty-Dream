...
<head>
    ...
    <title>Record Incoming - Dainty Dream</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="navbar">
        <h2>👗 Dainty Dream - Record Incoming</h2>
    </div>

    <div class="container">
        <div class="form-card">
            <h1><img src="{{ asset('StockInAdd.png') }}" alt="incoming icon" style="height: 30px; width: 30px; margin-right: 10px; vertical-align: middle;"> Record Incoming Transaction</h1>
